    ...
    return (
        <div className='text-light container-fluid' id='foot'>
            ...
            <div className="box2">
                    ...
                    <p id="footPara">
                       This is News WebApp,I made it using react,Html,Css,JavaScript also used Bootstrap and many other refernces for desgining the app.This app is design such that is provides live news to you but unfortunately the Free new API i have used provide only localhost request.So I am shiwning 
                    </p>
                    </div>
