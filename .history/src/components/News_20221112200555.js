  ...
  render() {
    return (
      ...
      {loading&&<Spinner/>}
        ...
        <button disabled={page<=1} type="button" className="btn btn-dark btn-sm mx-2" onClick={this.handlePrevClick}>&larr; Previous</button>
        <button disabled={page+1>Math.ceil(totalResults/props.pageSize)} type="button" className="btn btn-dark btn-sm mx-2" onClick={this.handleNextClick}>Next &rarr;</button>
