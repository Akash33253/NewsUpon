...
import science from "../newsFile/health.json"
...
export default function News(props) {
  ...
  const updateNews = async()=>{
    ...
    //  let data = await fetch(url);
     ...
     {
       parsedData = general.json()//await data.json(); 
     }
     else if(props.category==='business'){
        parsedData = business.json();
     }
     else if(props.category==='technology'){
        parsedData = technology.json();
     }
     else if(props.category==='health'){
        parsedData = health.json();
     }
     else if(props.category==='sports'){
        parsedData = sports.json();
     }
     else if(props.category==='science'){
        parsedData = science.json();
     }
     else{
        parsedData= entertainment.json();
     }
