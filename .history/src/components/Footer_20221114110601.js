    ...
    return (
        <div className='text-light container-fluid' id='foot'>
            ...
            <div className="box2"style={{ border: "2px solid white" }}>
                    ...
                    <p id="footPara">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus, quasi sint minus id, molestiae pariatur harum aliquam doloribus commodi, soluta hic. Assumenda dolorum neque a, beatae soluta id culpa magnam excepturi fugiat ipsam blanditiis consequatur explicabo vitae ullam tenetur tempore illo aspernatur repudiandae voluptate. Corporis quia nobis at aspernatur consequuntur.
