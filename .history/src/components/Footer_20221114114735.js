        ...
        <div className='text-light container-fluid' id='foot'>
            ...
            <div className="box2">
                    ...
                    <ul id="footList">
                        ...
                        <li><Link Link className="nav-link"to="/business">Entertainment</Link></li>
                        <li><Link Link className="nav-link"to="/business">Health</Link></li>
                        <li><Link Link className="nav-link"to="/business">Science</Link></li>
                        <li><Link Link className="nav-link"to="/business">Technology</Link></li>
                    </ul>
                    <p id="footPara">
